...
export const LampContainer = ({
  ...
  const [initialWidth1, setInitialWidth1] = useState("15rem");
    ...
    >
      <div className="container">
        <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
          ...
          <div className="absolute inset-auto z-50 h-36 w-[30rem] -translate-y-1/2 rounded-full bg-orangecmi opacity-50 blur-3xl"></div>
          <motion.div
            // initial={{ width: "8rem" }}
